<template>
    <li class="mb-4 p-3 rounded bg-gray-200 hover:bg-gray-300 cursor-pointer flex justify-between items-center transitionItem"
        @click="showTask">
        ...
        <div class="flex">
            ...
            <div class="ml-1" @click.stop="deleteTask">
